...
profile_edit_page = blueprints.Blueprint('profile_edit_page', __name__,static_folder='static',template_folder='templates')

profile_page = blueprints.Blueprint('profile_page', __name__,static_folder='static',template_folder='templates')

verify_page = blueprints.Blueprint('verified', __name__,static_folder='static',template_folder='templates')
